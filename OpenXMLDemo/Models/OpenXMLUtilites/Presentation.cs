...
namespace OpenXMLDemo.Models.OpenXMLUtilites
{
    public class Presentation
    {
        ...
        //        titleShape.TextBody = new TextBody(new D.Drawing.BodyProperties(),
        //                new D.Drawing.ListStyle(),
        //                new D.Drawing.Paragraph(new Drawing.Run(new Drawing.Text() { Text = slideTitle })));
        ...
        //                                new D.ListStyle(),
        //                                new Paragraph(new D.EndParagraphRunProperties() { Language = "en-US" }))))),
        ...
        //            new D.BodyProperties(),
        //            new D.ListStyle(),
        //            new Paragraph(new D.EndParagraphRunProperties()))))),
        //        new ColorMapOverride(new D.MasterColorMapping()));
